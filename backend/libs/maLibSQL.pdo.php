 ...
 * Il nécessite d'avoir défini les variables $BDD_Pseudo, $BDD_password $BDD_chaine dans config.php, qui est chargé au moment de l'appel de la librairie
 ...
 * @param string $sql
 * @return bool|int nombre d'enregistrements affectés, ou false si pb...
 * @pre Les variables  $BDD_Pseudo, $BDD_password $BDD_chaine doivent exister
 */
